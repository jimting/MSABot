...
CMD apt-get update && apt-get install -y firefox
 
# Gecko Driver
ENV GECKODRIVER_VERSION 0.26.0
CMD wget --no-verbose -O /tmp/geckodriver.tar.gz https://github.com/mozilla/geckodriver/releases/download/v$GECKODRIVER_VERSION/geckodriver-v$GECKODRIVER_VERSION-linux64.tar.gz \
